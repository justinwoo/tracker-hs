...
/***/ function(module, exports, __webpack_require__) {
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_Utils.eq(i, _p1.cursor) ? 'table-info' : '')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(x.count)
								]))
						]));
			});
		var rows = A2(_elm_lang$core$List$indexedMap, makeRow, _p1.showData);
		var showsTable = A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('col-md-6 col-sm-12')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('tracker')
						])),
					showsTable
				]));
	};
	var _user$project$Main$updateShowData = F2(
		function (model, _p2) {
			var _p3 = _p2;
			var mapper = F2(
				function (i, x) {
					return _elm_lang$core$Native_Utils.eq(x.name, _p3.name) ? _elm_lang$core$Native_Utils.update(
						x,
						{count: _p3.count}) : x;
				});
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					showData: A2(_elm_lang$core$List$indexedMap, mapper, model.showData)
				});
		});
	var _user$project$Main$initModel = {
		showData: _elm_lang$core$Native_List.fromArray(
			[]),
		cursor: 0
	};
	var _user$project$Main$updateRequests = _elm_lang$core$Native_Platform.outgoingPort(
		'updateRequests',
		function (v) {
			return {target: v.target, name: v.name};
		});
	var _user$project$Main$updateShow = F2(
		function (target, _p4) {
			var _p5 = _p4;
			var name = function () {
				var _p6 = A2(_elm_community$list_extra$List_Extra_ops['!!'], _p5.showData, _p5.cursor);
				if (_p6.ctor === 'Just') {
					return _p6._0.name;
				} else {
					return '';
			...
			return _user$project$Main$updateRequests(
				{target: target, name: name});
		});
	var _user$project$Main$incrementShow = _user$project$Main$updateShow('increment');
	var _user$project$Main$decrementShow = _user$project$Main$updateShow('decrement');
			...
			switch (_p7.ctor) {
					...
					if (_p8.ctor === 'Up') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									cursor: A2(_elm_lang$core$Basics$max, 0, model.cursor - 1)
								}),
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									cursor: A2(
										...
										model.cursor + 1,
										_elm_lang$core$List$length(model.showData))
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				case 'Decrement':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$decrementShow(model)
					};
				case 'Increment':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$incrementShow(model)
					};
				case 'ShowDataUpdate':
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Main$updateShowData, model, _p7._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
	...
	var _user$project$Main$showDataUpdates = _elm_lang$core$Native_Platform.incomingPort(
		'showDataUpdates',
		A2(
			...
			function (name) {
				return A2(
					_elm_lang$core$Json_Decode$andThen,
					A2(_elm_lang$core$Json_Decode_ops[':='], 'count', _elm_lang$core$Json_Decode$string),
					function (count) {
						return _elm_lang$core$Json_Decode$succeed(
							{name: name, count: count});
					});
			}));
	var _user$project$Main$Show = F2(
		function (a, b) {
			return {name: a, count: b};
		});
	var _user$project$Main$Model = F2(
		function (a, b) {
			return {showData: a, cursor: b};
		});
	var _user$project$Main$Down = {ctor: 'Down'};
	var _user$project$Main$Up = {ctor: 'Up'};
	var _user$project$Main$ShowDataUpdate = function (a) {
		return {ctor: 'ShowDataUpdate', _0: a};
	};
	var _user$project$Main$Decrement = {ctor: 'Decrement'};
	var _user$project$Main$Increment = {ctor: 'Increment'};
	var _user$project$Main$MoveCursor = function (a) {
		return {ctor: 'MoveCursor', _0: a};
	};
	var _user$project$Main$NoOp = {ctor: 'NoOp'};
	var _user$project$Main$handleKeyDown = function (x) {
		var _p9 = x;
		switch (_p9) {
			case 74:
				return _user$project$Main$MoveCursor(_user$project$Main$Down);
			case 75:
				return _user$project$Main$MoveCursor(_user$project$Main$Up);
			default:
				return _user$project$Main$NoOp;
		}
	};
	var _user$project$Main$handleKeyUp = function (x) {
		var _p10 = x;
		switch (_p10) {
			case 188:
	...
	var _user$project$Main$subscriptions = function (_p11) {
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$keyboard$Keyboard$downs(_user$project$Main$handleKeyDown),
					_elm_lang$keyboard$Keyboard$ups(_user$project$Main$handleKeyUp),
					_user$project$Main$showDataUpdates(_user$project$Main$ShowDataUpdate)
				]));
	};
	...
	var _user$project$Main$UpdateDecrement = {ctor: 'UpdateDecrement'};
	var _user$project$Main$UpdateIncrement = {ctor: 'UpdateIncrement'};
